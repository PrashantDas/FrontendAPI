...
backend_url = 'https://prashantrestdjango.onrender.com/'

def home_view(request):
    subdirectory = 'api/notes/notes-public/'
    link = backend_url + subdirectory
...
def make_notes(request):
    subdirectory = 'api/notes/notes-view/'
    link = backend_url + subdirectory
...
def login_view(request):
    ...
    subdirectory = 'api/members/login/'
    link = backend_url + subdirectory
...
def register_view(request):
    subdirectory = 'api/members/register/'
    link = backend_url + subdirectory
...
def profile_view(request):
    subdirectory = 'api/members/profile/'
    link = backend_url + subdirectory
